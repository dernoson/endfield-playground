# W0831-A1｜aaaaa｜工具列接真實機器資料（R-B1 資料／容器側）
...
| 性質 | 資料 → 工具列容器（**本週只做這一種**） |
| 預估時數 | **6–10h**；**文件上限：回覆錯字／PR 描述即可，禁止再開全員派工** |
...
| [W0831-G1](../../goodmorning/0831/W0831-G1_machine_card.md) | 吃你攤好的 `id`／`name`／`sizeText`；**未交你用列表頂替，演示仍算你的** |
| B2（封鎖） | 本週不接落子；只留「要放這台」的意圖即可 |
| shirone E001 交接 | **只收檔、確認範圍**；本週不實作 detector |

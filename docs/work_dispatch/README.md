...
| meta | value |
|------|-------|
| version | **v3.7（2026-09-23；主編裁決回寫）** |
| 本週區間 | **2026-09-21 → 2026-09-27**（[WEEK_20260921](./WEEK_20260921.md) **v1.1**）｜**M2 門檻日 9/27** |
| 上週區間 | 2026-09-14 → 2026-09-20（[WEEK_20260914](./WEEK_20260914.md) v1.1） |
| 上游 | [ROADMAP_OUTLINE](../roadmap/ROADMAP_OUTLINE.md) **v1.12** |
...
| [goodmorning](./goodmorning/0921/) | [G1](./goodmorning/0921/W0921-G1_toolbar_pr48_land.md) | **本週無交付要求**；#48 維持現狀不合不關 |
...
| [MBD](./MBD/0921/) | [M0](./MBD/0921/W0921-M0_pause.md) | **暫停**（原 M1 作廢）；樣式工作已轉 shirone |
...
6. `ToolbarPanel.vue` 按區塊分鎖：`<script>`＝toby（**本週即生效，不等 #48**）／`<template>`＋`<style>`＝goodmorning
...
11. **#48 維持現狀，不合也不關**；不列合入序、不計待審
12. 合入序：S1 搬家 → A0 → T1 → H1 → A1 →（S1 樣式，無死線）
...
| 檔 | 狀態 |
|----|------|
| WEEK_20260921 | **v1.1**（主編裁決已回寫，見 §2.0） |
| ROADMAP_OUTLINE | **v1.12** |
